  ...
  return (
    <div className='my-container'>
      <div className='text-center'>
        ...
        <p className='text-md text-gray-500'>Explore thousands of job opportunities with all the information you need. Its your future</p>
      </div>
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 mt-8">
          {jobsCategory.map((jobCategory, index) => (
            <div key={index} className="max-w-sm p-6 bg-gray-50 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <a href="#">
                <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white mt-4">{jobCategory.name}</h5>
              </a>
